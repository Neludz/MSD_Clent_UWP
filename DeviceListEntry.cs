...
namespace CustomSerialDeviceAccess
{
    ...
    public class DeviceListEntry
    {
        ...
        public DeviceListEntry(Windows.Devices.Enumeration.DeviceInformation deviceInformation, String deviceSelector, String PortNumber)
        {
